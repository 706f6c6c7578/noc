...
func main() {
    ...
    certFile := "server.crt" // Path to the certificate
    ...
    tlsConfig := &tls.Config{
        MinVersion: tls.VersionTLS12, // Mindestversion TLS 1.2
    }
    ...
    fmt.Println("Server is running on https://localhost:8083")
...
func handleUpload(w http.ResponseWriter, r *http.Request) {
    ...
    if len(content) > maxFileSize {
        http.Error(w, "Maximum allowed message size 42 KB!", http.StatusBadRequest)
        return
    }
